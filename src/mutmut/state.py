...
class MutmutState:
    ...
    Attributes:
        ...
        mutant_generation_time: Time taken for mutant generation phase.
        clean_tests_time: Time taken for clean tests phase.
        forced_fail_time: Time taken for forced fail test phase.
        mutation_testing_time: Time taken for mutation testing phase.
    """
