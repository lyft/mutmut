...
class CacheStatus(str, Enum):
    ...
    def __lt__(self, other: object) -> bool:
        """Compare by severity: CACHED < STALE_DEPENDENCY < INVALID."""
    ...
    def __gt__(self, other: object) -> bool:
        """Compare by severity: INVALID > STALE_DEPENDENCY > CACHED."""
        if not isinstance(other, CacheStatus):
            return NotImplemented
        return self._severity() >= other._severity()
    ...
    @classmethod
    def worst(cls, a: "CacheStatus", b: "CacheStatus") -> "CacheStatus":
        """Return the worse of two statuses."""
        return a if a._severity() > b._severity() else b
